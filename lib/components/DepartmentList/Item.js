...
var _IngredientList = _interopRequireDefault(require("../IngredientList/IngredientList"));
...
function (_Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      return _react.default.createElement("li", {
        key: this.props.key
      }, _react.default.createElement("h2", null, this.props.department), _react.default.createElement(_IngredientList.default, {
  ...
  return Item;
}(_react.Component); // @TODO i think we can use this.props.key, but on parent component
